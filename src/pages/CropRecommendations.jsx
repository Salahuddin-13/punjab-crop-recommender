                    ...
                    <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                           <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-6">
                                ...
                                <div className="sm:col-span-2"><FilterSelect name="investmentBudget" label="Investment Budget (per acre)" value={filters.investmentBudget} onChange={handleFilterChange} options={[{label: "Low (Upto ₹20,000)", value: 20000}, {label: "Medium (Upto ₹40,000)", value: 40000}, {label: "High (Upto ₹60,000)", value: 60000}, {label: "Very High (Above ₹60,000)", value: 200000}]} placeholder="Select Budget Range"/></div>
